        ...
        body: Stack(
          children: [
            ...
            ListView(children: [
              ...
              SingleCard(
                dia: 'Lunes',nav: 'lunes',foto: 'assets/fondo.jpg',
              ),
              SingleCard(dia: 'Martes',nav: 'martes',foto: 'assets/fondo.2.jpg',),
               SingleCard(dia: 'Miercoles',nav: 'miercoles',foto: 'assets/fondo.3.jpg',),
               SingleCard(dia: 'Jueves',nav: 'jueves',foto: 'assets/fondo.4.jpg',),
               SingleCard(dia: 'Viernes',nav: 'viernes',foto: 'assets/fondo.1.jpg',),
               SingleCard(dia: 'Sabado',nav: 'sabado',foto: 'assets/fondo.5.jpg',),
               SingleCard(dia: 'Domingo',nav: 'domingo',foto: 'assets/fondo.6.jpg',),
            ])
          ],
        ),
      ),
